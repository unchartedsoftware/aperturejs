...
function publish(symbolSet) {
	publish.conf = {  // trailing slash expected for dirs
		...
		templateVersion: "1.2, with custom mods",
	...
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"body.jpg", publish.conf.outDir+"/"+publish.conf.cssDir);
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"header.jpg", publish.conf.outDir+"/"+publish.conf.cssDir);
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"home.png", publish.conf.outDir+"/"+publish.conf.cssDir);
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"aperturets.png", publish.conf.outDir+"/"+publish.conf.cssDir);
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"aperture-big.png", publish.conf.outDir+"/"+publish.conf.cssDir);
	IO.copyFile(publish.conf.templatesDir+"/"+publish.conf.cssDir+"aperture-16x16.ico", publish.conf.outDir+"/"+publish.conf.cssDir);
